...
def outlier_detection(
    ...
    cifar10_test_features = torch.stack(cifar10_test_features, dim=0).to(device).detach()
    ...
    cifar100_test_features = torch.stack(cifar100_test_features, dim=0).to(device).detach()
