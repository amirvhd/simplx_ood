...
def main():
    with open('~/amir/simplx_ood/experiments/results/cifar/outlier_sn/simplex_cifar_cv0.pkl', 'rb') as f:
        data_base = pkl.load(f)
    with open('~/amir/simplx_ood/experiments/results/cifar/outlier/simplex_cifar_cv0.pkl', 'rb') as f:
        data_sn = pkl.load(f)
