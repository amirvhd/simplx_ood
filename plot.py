...
def main():
    with open('/dss/dsshome1/lxc0C/ra49bid2/amir/simplx_ood/experiments/results/cifar/outlier_sn/simplex_cifar_cv0.pkl', 'rb') as f:
        data_base = pkl.load(f)
    with open('/dss/dsshome1/lxc0C/ra49bid2/amir/simplx_ood/experiments/results/cifar/outlier/simplex_cifar_cv0.pkl', 'rb') as f:
        data_sn = pkl.load(f)
    ...
    error_sn = ((data_sn.test_latent_reps - pred_sn) ** 2).sum(1).numpy()
